...
public class DialogueHandler {
	...
	public void sendDialogues(int dialogue, int npcId) {
		...
		break;
		case 5:
			sendNpcChat4("Hello adventurer...", "My name is Kolodion, the master of this land.", "Would you like to play a minigame in order ", 
		...
		break;
		case 35:
		sendNpcChat4 ( "There are several shop owners", "3 pk point shops, 1 is donator only", "There is also a vote point shop", "skilling shop and more!", c.talkingNpc, "RuneScape_Guide");
		c.nextChat = 36;
		break;
		case 36:
		sendNpcChat4 ( "That just about sums it up", "if you have any other questions", "talk to Damo or another", "staff member. Enjoy!", c.talkingNpc, "RuneScape_Guide");
		c.nextChat = 37;
		break;
		case 37:
		sendPlayerChat2("Good! Now shut the fuck up", "and let me play!!");
		c.nextChat = 0;
		break;
		case 14:
		...
		break;
/*		case 24:
			sendNpcChat4("*Sniff* *sniff*", "Oh.. Hello child... I don't suppose you could", "help me find something that I lost... Could you?", 
			"I think I might have a reward for you..!", c.talkingNpc, "Santa");
			c.nextChat = 25;
		break;
		case 25:
			sendOption2("Sure, I'll help you!", "No way tubby, go search up your ass");
			c.dialogueAction = 15;
		break;*/
