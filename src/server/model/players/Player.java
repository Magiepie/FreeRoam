...
public int follow2 = 0;
	...
	public final String[] PRAYER_NAME = 		{"Thick Skin", "Burst of Strength", "Clarity of Thought", "Sharp Eye", "Mystic Will", "Rock Skin", "Superhuman Strength", "Improved Reflexes","Rapid Restore", 
												...
												"Protect from Melee","Eagle Eye", "Mystic Might", "Retribution", "Redemption", "Smite", "Chivalry", "Turmoil"};
	...
	public boolean isInFunPk() {
		          //unsafeBL          unsafeTR           unsafeBL           unsafe TR
		//if(absX > 3006 && absX < 3022 && absY > 3350 && absY < 3361) {
	                if((absX > 2930 && absX < 3009 && absY > 3304 && absY < 3393)
                              || (absX > 3021 && absX < 3067 && absY > 3318 && absY < 3390)
	              || (absX > 3008 && absX < 3022 && absY > 3320 && absY < 3353)) {	
			return true;
		}
	//if(absX > 3009 && absX < 3018 && absY > 3353 && absY < 3358) {
		return false;
	}
	...
	public int oBankItems[] = new int[Config.BANK_SIZE];
	public int oBankItemsN[] = new int[Config.BANK_SIZE];
	...
	public Player(int _playerId) {
		...
		teleportToX = 3086; //3275
		teleportToY = 3493; //3167
