...
/*	if(!c.getItems().antiDupe(itemID,fromSlot,amount))
		{
	System.out.println("Player "+c.playerName+" is trying to dupe arrows.");
		return false;
		}
*/
	...
	**/
	...
	public void sendWeapon(int Weapon, String WeaponName) {
		...
		} else if (c.playerEquipment[c.playerWeapon] == 4153 || c.playerEquipment[c.playerWeapon] == 13902)  {
	...
	**/
	...
	public void getRequirements(String itemName, int itemId) {
		...
		switch(itemId) {
			...
			case 13736: // if you don't want to use names 
			c.magicLevelReq = 70;
			return;
